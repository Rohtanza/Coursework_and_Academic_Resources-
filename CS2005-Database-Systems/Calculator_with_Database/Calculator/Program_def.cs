...
namespace CalculatorApp
{
    ...
    {
        private static Window updateWindow; 
        ...
        private static void SaveCalculations(double operand, double result, string operator1)
        {
            ...
            string connectionString = "Server=localhost;Database=Calculator;User Id=sa;Password=Zainabali125!@#;"; 
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                Console.Write("Data Written SuccessFully on DataBase");
            }
        }
        ...
        private static void UpdateCalculationWindow(Calculation calculation)
        {
            ...
            {
                Text = calculation.Operand1.ToString() 
            };
            ...
            {
                Text = calculation.Operand2.ToString() 
            };
